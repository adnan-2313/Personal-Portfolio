  ...
  return (
    <footer className="fixed overflow-hidden z-[-1] w-full top-0 h-full  bg-black text-white">
      ...
      <div className="sm:px-[2.5rem] max-sm:px-14  mt-[7rem] max-sm:mt-3 ">
        ...
        <div className="sm:fixed max-sm:mt-2 max-sm:mx-auto bottom-0 w-full lg:pr-[80px] flex flex-row max-sm:flex-col max-sm:justify-center max-sm:items-center justify-between ">
