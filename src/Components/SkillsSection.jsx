...
const SkillsSection = () => {
  return (
    <section className="mt-[25rem] overflow-hidden max-lgpx-[10rem]  pb-[5rem]  w-full relative z-[-1] 
    bg-[#0d101c80]
    ">
      <div className="w-[50%] max-md:w-[70%] mx-auto mt-[10rem]" id="skills">
        ...
        <p className="font-DMSANS  bg-gradient-to-tr from-[#2cf8ff] to-[#18ffb0] bg-clip-text text-transparent 
        ...
        {skills.map((items, index) => {
          return (
            <div
              ...
              backdrop-blur-[40px] text-white w-[25rem] p-[40px_30px] max-sm-phone:p-[35px_20px] flex flex-col justify-center"
              key={index}
            >
                ...
                {items.skills.map((skill, index) => {
                  return (
                    <div
                      ...
                      items-center gap-2"
                    >
                      <img src={skill.image} loading="lazy" alt={skill.name} className="size-8 max-sm-phone:size-6"></img>
      ...
      <div className="z-[1] bg-[#18ffb0] blur-[120px] rounded-[50%] w-[30rem] h-[20rem] block absolute  opacity-[.7]  
       inset-[20%_auto_auto_10%] max-lg:w-[40rem] max-lg:h-[30rem] max-min-tab:h-[20rem] max-min-tab:w-[15rem]"></div>
      <div className="z-[1] bg-[#2cf8ff] blur-[120px] rounded-[50%] w-[20rem] h-[20rem] absolute 
      opacity-[.56]   inset-[60%_0%_0%_80%] max-lg:inset-[75%_0%_0%_30%] max-lg:w-[30rem] max-lg:h-[30rem] max-min-tab:h-[15rem] max-min-tab:w-[15rem]"></div>
    </section>
  );
};
