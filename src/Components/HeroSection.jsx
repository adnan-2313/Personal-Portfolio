  ...
  return (
    <main className="flex flex-row relative  text-white max-lg:flex-col  w-full justify-between mb-[1rem] max-w-[75rem]  ">
      ...
      <div  className="w-[100%] mt-[2rem]  font-montserrat  flex flex-col max-lg:ml-[2rem] max-sm:mr-[2rem] ">
        <h1 data-aos="fade-down"  className="bg-gradient-to-tr from-[#2cf8ff]  to-[#18ffb0] bg-clip-text text-transparent text-[.875rem] ">
          FRONT END DEVELOPER & PROGRAMMER
        </h1>
        <p data-aos="fade-left"  className="font-spaceGrotesk text-[3.8rem] max-lg:text-[3rem] max-sm:text-[2.25rem] max-sm-phone:text-[2.15rem] max-sm:leading-tight w-[100%]  p-[20px_21px_0px_0px]   border-white font-semibold leading-[3.8rem]">
      ...
      <div className="absolute overflow-hidden border-[1px] 
      backdrop-filter-[40px]
       bg-black
        border-gray-700 p-[10px]   left-[-4rem] font-montserrat text-white bottom-[2rem] text-xl rounded-[50%] ">
        <img
          src={img}
          alt=""
          loading="lazy"
          className="h-[7.125rem] w-[7.125rem]  top-0 animate-[spin_10s_linear_infinite]"
        />
        <img loading="lazy" src={logo} className="absolute h-[2.2rem] w-[2.2rem]  top-[2.9rem] left-[3rem] "/>
