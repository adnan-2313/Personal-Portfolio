...
const HeroSection = () => {
  return (
    <main className="flex flex-row relative text-white max-lg:flex-col  w-full justify-between mb-[1rem] max-w-[70rem]  ">
      ...
      <div className="w-[100%] my-[4rem] font-montserrat flex flex-col border-2 ">
        ...
        hover:bg-[linear-gradient(98deg_#02b09b61_#02b09b33)] hover:translate-y-[-1px] hover:shadow-[0_20px_40px_#2db58633] max-lg:w-[45%] max-lg:py-[.6rem]"
        >
